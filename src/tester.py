...
def train_recognizer(nameIndex, name):
    images = []
    labels = []
    label = nameIndex  
    people.append((nameIndex,name)) # add to tuple index and name 
...
train_recognizer(1, "joe biden")  # joe biden is index 1
...
image_path = 'C:/Users/ccamn/Desktop/Facial recognition/testimage.jpg'  # Provide the path to your image
...
for (x, y, w, h) in faces:
    ...
    if confidence < THRESHOLD:
        nameIndex, name = people[int(label) - 1]  # Unpack the tuple
